                        ...
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <span class="il"
                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';color:#3d4852;font-size:19px;font-weight:bold;text-decoration:none;display:inline-block">{{env('APP_NAME')}}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td width="100%" cellpadding="0" cellspacing="0"
                                    ...
                                    <table class="m_3660024897648221795inner-body" align="center" width="570"
                            ...
                            <tr>
                                <td
                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                    <table class="m_3660024897648221795footer" align="center" width="570"
                                        cellpadding="0" cellspacing="0" role="presentation"
                                                ...
                                                <td align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        © {{\Carbon\Carbon::now()->format('Y')}} <span
                                                            class="il">{{env('APP_NAME')}} |</span> All rights reserved.
                                                    </p>
